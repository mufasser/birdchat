...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
       ...
       attach(self, source, {change: "source.change",click:'source.click'}); //click:'source.click' is added later by Konok. Need to attach here before call. 
        ...
        /***Added by Konok, for clicking on the source after putting value with jquery & replace text in Emojiarea**/
        .on("@source.click", function() {
            self.setText(source[sourceValFunc]());
            trigger('change');
        })
