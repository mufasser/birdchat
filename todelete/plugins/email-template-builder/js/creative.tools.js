			...
			'<div class="modal-dialog'+(s.large?' modal-lg':'')+'">'+
				'<div class="modal-content">'+
					'<div class="modal-header text-primary">'+
						(s.header!="" ? '<h5 class="modal-title">'+s.header+'</h5>' : '' )+
						(s.close===true?'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>':'')+
					'</div>'+
					'<div class="modal-body p-0 pt-3">'+s.content+'</div>'+
					(s.footer!=""?'<div class="modal-footer bg-whitesmoke">'+
					 	s.footer+
					'</div>':'')+
				'</div>'+
			'</div>'+
