 ...
 *             Version 2.0
 */
require_once FCPATH.'application/libraries/Google/Api/Ads/Common/Lib/AdsUser.php';
require_once FCPATH.'application/libraries/Google/Api/Ads/Common/Util/Logger.php';
require_once FCPATH.'application/libraries/Google/Api/Ads/Common/Util/MapUtils.php';
require_once FCPATH.'application/libraries/Google/Api/Ads/Common/Util/SoapRequestXmlFixer.php';
require_once FCPATH.'application/libraries/Google/Api/Ads/Common/Util/XmlUtils.php';
require_once FCPATH.'application/libraries/Google/Api/Ads/Common/Util/DeprecationUtils.php';
