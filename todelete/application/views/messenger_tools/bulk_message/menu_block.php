  ...
  if($this->recurring_notification_exist) { ?>
    <div class="col-12 col-md-4">
        ...
        <div class="wizard-step wizard-step-light">
          ...
          <div class="wizard-step-label">
            <?php echo $this->lang->line("Recurring Notification Broadcast"); ?>
          </div>
          <p class="text-muted mt-3"><?php echo $this->lang->line("Recurring Notification request follow-up message broadcasting."); ?></p>       
        </div>
        </a>
      </div>
    </div>
