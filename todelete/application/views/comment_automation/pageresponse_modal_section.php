<div class="modal fade" id="pageresponse_auto_reply_message_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" style="min-width: 70%;">
        ...
        <div class="row" style="padding: 10px 20px 10px 20px;">
          ...
          <div class="col-12">
            <?php if(ai_reply_exist()) : ?>
              ...
              <input type="radio" name="pageresponse_message_type" value="ai_reply" id="pageresponse_ai_reply" class="custom-control-input radio_button">
              <label class="custom-control-label" for="pageresponse_ai_reply"><?php echo $this->lang->line("automated reply by AI") ?></label>
              </div>
            <?php endif; ?>
            <div class="custom-control custom-radio">
          ...
          <div class="col-12" id="pageresponse_ai_message_div" style="display: none;">
              <div class="form-group clearfix" style="border: 1px dashed #e4e6fc; padding: 20px;">
                  ...
                  <textarea class="form-control" name="pageresponse_ai_training_data" id="pageresponse_ai_training_data" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
              </div>
              ...
              <div>                      
                <select class="form-group private_reply_postback" id="pageresponse_ai_message_private" name="pageresponse_ai_message_private">
                  <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                </select>
        ...
        <input type="hidden" name="pageresponse_ai_reply_enabled" value="0" id="pageresponse_ai_reply_enabled">
            </div>
            </form>
    ...
    <div class="modal-dialog modal-lg" style="min-width: 70%;">
        ...
        <div class="row" style="padding: 10px 20px 10px 20px;">
          ...
          <div class="col-12">
            <?php if(ai_reply_exist()) : ?>
              <div class="custom-control custom-radio">
              <input type="radio" name="pageresponse_edit_message_type" value="ai_reply" id="pageresponse_edit_ai_reply" class="custom-control-input radio_button">
              <label class="custom-control-label" for="pageresponse_edit_ai_reply"><?php echo $this->lang->line("automated reply by AI") ?></label>
              </div>
            <?php endif; ?>
            <div class="custom-control custom-radio">
          ...
          <div class="col-12" id="pageresponse_edit_ai_message_div" style="display: none;">
              <div class="form-group clearfix" style="border: 1px dashed #e4e6fc; padding: 20px;">
                  <label>
                      <i class="fa fa-robot"></i> <?php echo $this->lang->line("AI training data") ?> <span class="red">*</span>
                  </label>
                  <textarea class="form-control" name="pageresponse_edit_ai_training_data" id="pageresponse_edit_ai_training_data" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
              </div>
              ...
              <div>                      
                <select class="form-group private_reply_postback" id="pageresponse_edit_ai_message_private" name="pageresponse_edit_ai_message_private">
                  <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                </select>
        ...
        <input type="hidden" name="pageresponse_edit_ai_reply_enabled" value="0" id="pageresponse_edit_ai_reply_enabled">
            </div>
            </form>
