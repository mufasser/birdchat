<style type="text/css">
	...
	#comment_lists .makeScroll{max-height: 500px;overflow:auto;}
    ...
    .empty-state img { height: 200px;}
    .emojionearea.small-height { height: 140px !important; }
    .w-100 { width: 100%; }
	.bbw{border-bottom-width: thin !important;border-bottom:solid .5px #e8e8e8 !important;padding-bottom:20px;}
	...
	#hashtag_search_result .card-header { padding: 10px !important;min-height:50px; }
