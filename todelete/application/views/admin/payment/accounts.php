                ...
                <div class="row">
                 ...
                 <div class="row">
                  ...
                  <div class="col-12 col-md-3">
                    <div class="form-group">
                      <label for=""><i class="fas fa-vial"></i> <?php echo $this->lang->line('Mercadopago Sandbox Mode');?></label>
                      <br>
                      <?php 
                      $mercadopago_mode =isset($xvalue['mercadopago_mode'])?$xvalue['mercadopago_mode']:"";
                      if($mercadopago_mode == '') $mercadopago_mode='live';
                      ?>
                      <label class="custom-switch mt-2">
                        <input type="checkbox" name="mercadopago_mode" value="sandbox" class="custom-switch-input"  <?php if($mercadopago_mode=='sandbox') echo 'checked'; ?>>
                        <span class="custom-switch-indicator"></span>
                        <span class="custom-switch-description"><?php echo $this->lang->line('Enable');?></span>
                        <span class="red"><?php echo form_error('mercadopago_mode'); ?></span>
                      </label>
                    </div>
                  </div>
