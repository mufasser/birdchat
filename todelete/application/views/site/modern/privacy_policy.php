	...
	<div class="row">
		<div class="col-xs-12" >
			<div class="left-content">
				<h1>
					<span style="color:<?php echo $THEMECOLORCODE;  ?> ">Privacy Policy</span>
				</h1>
				<br>
				<p>Welcome to <?php echo base_url(); ?> (the Site).We understand that privacy online is important to users of our Site, especially when conducting business.This statement governs our privacy policies with respect to those users of the Site (Visitors) who visit without transacting business and Visitors who register to transact business on the Site and make use of the various services offered by This APP (collectively, Services) (Authorized Customers).</p>
				...
				<p><b>What Personally Identifiable Information is collected? </b></p>
				...
				<p><b>What organizations are collecting the information? </b></p>
				...
				<p><b>How does the Site use Personally Identifiable Information?</b></p>
				...
				<p><b>With whom may the information may be shared?</b></p>
				...
				<p><b>How is Personally Identifiable Information stored?</b></p>
				...
				<p><b>What choices are available to Visitors regarding collection, use and distribution of the information?</b></p>
				...
				<p id="cookie_policy"><b>Are Cookies Used on the Site?</b></p>
				...
				<p><b>How does This APP use login information? </b></p>
				...
				<p><b>What partners or service providers have access to Personally Identifiable Information from Visitors and/or Authorized Customers on the Site?</b></p>
				...
				<p><b>How does the Site keep Personally Identifiable Information secure?</b></p>
				...
				<p><b>How can Visitors correct any inaccuracies in Personally Identifiable Information?</b></p>
				<p>Visitors and Authorized Customers may contact us to update Personally Identifiable Information about them or to correct any inaccuracies by emailing us at <?php echo $this->config->item('institute_email'); ?></p>
				<p><b>Can a Visitor delete or deactivate Personally Identifiable Information collected by the Site?</b></p>
				...
				<p><b>What happens if the Privacy Policy Changes?</b></p>
				...
				<p><b>Links:</b></p>
				<p><?php echo base_url(); ?> contains links to other web sites. Please note that when you click on one of these links, you are moving to another web site. We encourage you to read the privacy statements of these linked sites as their privacy policies may differ from ours.</p>
				<br>
				<br>
				<br>
				<br>
