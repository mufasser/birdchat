...
class Social_accounts extends Home
{
    ...
    public function broadcast()
    {
        ...
        if (file_exists($broadcast_file_path)) {
            ...
            echo "File does not exist: " . $broadcast_file_path;
        }
    }
    public function birdchat_ai()
    {
        $birdchat_ai_file_path = APPPATH . 'views/birdchat_ai/birdchat_ai.php';
        if (file_exists($birdchat_ai_file_path)) {
            $this->load->view('birdchat_ai/birdchat_ai');
        } else {
            echo "File does not exist: " . $birdchat_ai_file_path;
        }
    }
    public function analytics()
    {
        $analytics_file_path = APPPATH . 'views/analytics/analytics.php';
        if (file_exists($analytics_file_path)) {
            $this->load->view('analytics/analytics');
        } else {
            echo "File does not exist: " . $analytics_file_path;
        }
    }
