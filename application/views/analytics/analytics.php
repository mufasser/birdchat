...
<style>
    ...
    .badgee-warm{
background: var(--Background-success-Muted, #FECACA);
        ...
        <div class="main-wrapper">
            ...
            <div class="container" style="  display: flex;justify-content: space-between  ;   margin-right: 440px; ">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-primarye">Manage Segments</button>
                </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        <div class="card  p-3 mb-3 ">
                            <div class="d-flex justify-content-between">
                                ...
                                <p><span class="badgee badge ">+0%</span></p>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card  p-3 mb-3 ">
                            <div class="d-flex justify-content-between">
                                <h6>Response Time to All Messages</h6>
                                 <p><span class="badgee-warm badge ">+0%</span></p>
                            </div>
