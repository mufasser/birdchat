	...
	$("document").ready(function(){	
		...
		$(document).on('change','#page,#label_ids,#excluded_label_ids,#user_gender,#user_time_zone,#user_locale,#broadcast_type,#otn_postback_ids',function(){     
	      ...
	      if(load_otn_postback=='1')
	      {
	      	...
	      	$("#otn_postback_section").html('<?php echo $this->lang->line("Loading RCN templates..."); ?>');
	      }
		  ...
		  $.ajax({
			  type:'POST' ,
			  url: base_url+"home/get_rcn_broadcast_summary",
...
<?php include("application/views/messenger_tools/rcn_manager/message_tag_modal.php") ?>
