<style type="text/css">
  ...
  #sticky-footer{position: fixed;bottom: 0;left: 0;z-index: 100;text-align: center;}
  
  .card .card-header{min-height: auto !important;}
  #sticky-footer .breadcrumb{border-radius: 0;box-shadow: 0px 0 10px rgba(0, 0, 0, 0.2);}
  #sticky-footer .breadcrumb-item a{font-size: 14px;text-align: center;}
  #sticky-footer .breadcrumb-item a div{padding-top:8px;}
  #sticky-footer .breadcrumb-item i{font-size: 30px;margin:0;}
  #sticky-footer a{text-decoration: none;}
