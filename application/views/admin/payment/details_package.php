  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-4 col-12">
      <div class="card card-statistic-1">
        ...
        <div class="card-wrap">
          <div class="card-header">
            <h4><?php echo $this->lang->line("Price")?> - <?php echo isset($payment_config[0]['currency']) ? $payment_config[0]['currency'] : 'USD'; ?></h4>
          </div>
          <div class="card-body">
            <?php 
    ...
    <div class="col-12">      
      <div class="card">
        ...
        <div class="card-footer bg-whitesmoke">
          <button  type="button" class="btn btn-secondary btn-lg" onclick='goBack("payment/package_manager",0)'><i class="far fa-arrow-alt-circle-left"></i> <?php echo $this->lang->line("Go back");?></button>
        </div>
      </div> 
    </div>
  </div>
