...
<body class="hold-transition  sidebar-gone  layout-fixed" style="height: auto; background-color: #FFFFFF;">
    <div id="app">
		...
		<nav class="navbar " style="border-bottom: none !important;">
                    <form class="form-inline mr-auto" style="flex: auto;">
                        <a href="#" data-toggle="sidebar" class="nav-link nav-link-lg mr-0" id="collapse_me_plz">
                            <img src="<?php echo base_url('assets/images/img/closer.png'); ?>" class="img-fluid" alt="Avatar Image">
                        </a>
                    </form>
                </nav>
                    ...
                    <head id="collectSection" style="display:none; " class="row custom-row">
                        <header class="container py-3 d-flex justify-content-between align-items-center ">
                            ...
                            <div class="d-flex ">
                                  ...
                                  <button type="button" class="btn btn-primarye float-end">+ Create New Broadcast</button>
                            </div>
                        </header>
