<style>
	...
	.custom-headig {
		...
		/* Change this to 1 for visibility */
	...
	h2 {
		...
		opacity: 0px;
		/* font-family: Inter; */
		/* Uncomment this line if you want to use the Inter font family */
		font-size: 16px;
		font-weight: 500;
		line-height: 24px;
		text-align: left;
	...
	<header class="container ">
		<nav class=navbar>
			<ul class="nav nav-pills navpill justify-content-start">
				<li class="nav-item "><a class="nav-link" href="#" onclick="loadContent('collect')">Collect</a></li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('connect')">Connect</a></li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('convert')">Convert</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('automation')">Automation</a></li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('customize')">Customize</a>
				</li>
			</ul>
		</nav>
 ...
 <div class="breadcrumb-item"><?php echo $page_title; ?></div>
	...
	if ($this->session->userdata('success_message') == 'success') {
		echo '<div class="alert alert-success" role="alert">
			...
			$this->lang->line('Well Done!') .
			'</h4>
                            					  <p>' .
			$this->lang->line('Your account has been imported successfully.') .
			'</p>
                            					  <p class="mb-0">' .
			$this->lang->line('Whenever you need to refresh access token or sync new data just login with Facebook again.') .
			'</p>
                            					</div><br/>';
	...
	<div class="section-body">
														...
														<div class="card author-box">
															<div class="card-body pl-3 pr-2">
																...
																<div class="author-box-details">
																	...
																	<div class="author-box-job">
																		<small><i class="fas fa-circle text-success"></i>
																			<?php echo $page_info['page_id']; ?></small>
																	</div>
       ...
       <b><?php echo $this->lang->line('Followers'); ?></b> : <span id="follower_count_<?php echo $page_info['id']; ?>"><?php echo custom_number_format($page_info['insta_followers_count']); ?></span> -->
		...
		<?php else : ?>
			<!-- FROM HEAR -->
			<main id="mainContent" class="container py-4  sidebar-gone" style="margin-left: 6px">

				<!-- ///////////////////////first section start//////////////////////// -->
				<section id="collectSection" style="display:none; " class="row custom-row">
					<h2 style="    margin-top: 101px;">Collected Info</h2>
					<div class="row custom-row">

						<div class="card custom-card-1  flex-row  " style="margin-left: 12px; width: 328px;">
							<div class=" d-flex  ">
								<img src="<?php echo base_url('assets/images/img/googlicon.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top p-3 mt-2" alt="">
								<div class="">
									<p class=" custom-headig" style="padding-top: 25px ;margin-bottom: 2px">Google Form
									</p>
									<p class=" custom-p">Friday Chuas</p>
								</div>
							</div>
						...
						<div class="card custom-card-1  flex-row  " style="margin-left: 12px; width: 328px;">
							<div class=" d-flex  ">
								<img src="<?php echo base_url('assets/images/img/birdposmini.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top p-3 mt-2" alt="">
								<div class="">
									<p class=" custom-headig " style="padding-top: 25px ;margin-bottom: 2px">BirdPos Mini
									</p>
									<p class=" custom-p">Serenity sisters</p>
								</div>
							</div>
					...
					<h2>Available to Collect Info</h2>


					<!-- first card -->
					<div class="d-flex flex-row ">
						<div class="card  custom-card" style="height: 220px ;width: 328px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/googlicon.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/freeBadge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Google Form</p>
								<p class=" custom-p">Connect to Google form </p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
							</a>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/birdposmini.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">BirdPos Mini</p>
								<p class=" custom-p">Serenity sisters</p>
							</div>
							<hr>
							<a class="custom-button" href="">
				...
				<section id="connectSection" style="display:none;" class=" row custom-row">
					<h2 style="    margin-top: 101px;">Connected Channels </h2>
					<div class="row custom-row">
						<?php
						if ($this->session->userdata('logged_in')) {
							...
							// Check if the user has an API key in the database
							$query = $this->db->select('api_key')->where('id', $userId)->get('users');
							$result = $query->row();
						...
						?>
								<div class="card custom-card-1 flex-row" style="margin-left: 12px; width: 328px;">
									<div class="d-flex">
										<img src="<?php echo base_url('assets/images/img/whatssapp.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top p-3 mt-2" alt="">
										<div>
											<p class="custom-heading" style="padding-top: 25px; margin-bottom: 2px">Whatsapp</p>
											<p class="custom-p">Welcome <?php echo $username; ?></p>
											<!-- Other content here -->
										</div>
									</div>
								</div>
						...
						<div class="card custom-card-1 flex-row" style="margin-left: 12px; width: 328px;">
							<div class="d-flex">
								<img src="<?php echo base_url('assets/images/img/fb.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top p-3 mt-2" alt="">
								<div>
									<p class="custom-heading" style="padding-top: 25px; margin-bottom: 2px">Facebook</p>
									<p class="custom-p">Serenity sisters</p>
								</div>
							</div>
						</div>
					...
					<div class="d-flex flex-row ">
						<div class="card  custom-card" style="height: 220px ;width: 328px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/whatssapp.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Whatsapp</p>
								<p class=" custom-p">Connect to Whatsapp </p>
							</div>
							<hr>

							<button style="text-align: center; border: none; background: none; margin-top: -7px;" type="button" class="btn" >Connect</button>
							<!-- <button onclick="redirectToURL()" style="text-align: center; border: none; background: none; margin-top: -7px;" type="button" class="btn">Connect</button>

							<script>
								function redirectToURL() {
									window.location.href = 'https://hub.360dialog.com/dashboard/app/cKw8WdPA/permissions';
								}
							</script> -->

							<div id="myModal" class="modal" tabindex="-1" data-backdrop="false">
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title">360 Dialog</h5>
											<button type="button" class="close" data-dismiss="modal">&times;</button>
										</div>
										<div class="modal-body">
											<div class="form-group">
												<form action="<?php echo base_url('home/threedialog_register'); ?>" method="post">
													<label for="api_key">Api Key:</label>
													<input type="text" id="api_key" name="api_key" class="form-control me-2" placeholder="Enter Your Api Here">
											</div>
										</div>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/fb.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Facebook</p>
								<p class=" custom-p">SerConnect to Facebook</p>
							</div>
							<hr>
							<a class="custom-button" href="https://www.facebook.com/v10.0/dialog/oauth?client_id=677957711204119&state=17f26c590e612f4ed9696e1ff56d1a17&response_type=code&sdk=php-sdk-5.2.0&redirect_uri=http%3A%2F%2Flocalhost%2Fbird-chat-web%2Fsocial_accounts%2Fmanual_renew_account&scope=email%2Cpages_manage_posts%2Cpages_manage_engagement%2Cpages_manage_metadata%2Cpages_read_engagement%2Cpages_show_list%2Cpages_messaging%2Cpublic_profile%2Cread_insights%2Cbusiness_management%2Cinstagram_basic%2Cinstagram_manage_comments%2Cinstagram_manage_insights%2Cinstagram_content_publish%2Cinstagram_manage_messages">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
							</a>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/insta.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 55px; width: 80px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Instagram</p>
								<p class=" custom-p">Connect to Instagram</p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
					...
					<div class="d-flex flex-row ">
						<div class="card  custom-card" style="height: 220px ;width: 328px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/wechat.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">WeChat</p>
								<p class=" custom-p">Connect to WeChat</p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/linkchat.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">WeChat </p>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/messagechat.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Chat </p>
								<p class=" custom-p">Connect to Chat</p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
					...
					<div class="row">
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/chat2.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">WeChat </p>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/telegram.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Chat </p>
				...
				<!-- ///////////////////////third section start//////////////////////// -->
				<section id="convertSection" style="display:none;" class="row custom-row">
					<h2 style="    margin-top: 101px;">Connected </h2>
					<div class="row custom-row">

						<div class="card custom-card-1  flex-row  " style="margin-left: 12px; width: 328px;">
							<div class="d-flex">
								<img src="<?php echo base_url('assets/images/img/mastercard.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top p-3 mt-2" alt="">
								<div class="">
									<p class=" custom-headig" style="padding-top: 25px ;margin-bottom: 2px">MasterCard</p>
									<p class=" custom-p">**** **** **** **98</p>
								</div>
							</div>
						...
						<div class="card custom-card-1  flex-row  " style="margin-left: 12px; width: 328px;">
							<div class=" d-flex  ">
								<img src="<?php echo base_url('assets/images/img/shopify.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top p-3 mt-2" alt="">
								<div class="">
									<p class=" custom-headig " style="padding-top: 25px ;margin-bottom: 2px">Shopify</p>
									<p class=" custom-p">Jeremy Nikks</p>
								</div>
							</div>
					...
					<div class="d-flex flex-row ">
						<div class="card  custom-card" style="height: 220px ;width: 328px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/shopify.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/Badge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Shopify</p>
								<p class=" custom-p">Connect to Shopify </p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/visa.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/freeBadge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">Visa</p>
								<p class=" custom-p">Connect to Visa Account</p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
						...
						<div class="card  custom-card" style="height: 220px ;width: 328px; margin-left: 12px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/paypal.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/freeBadge.png'); ?>" style="height: 55px; width: 80px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">paypal</p>
								<p class=" custom-p">Connect to paypal account</p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
					...
					<div class="d-flex flex-row ">
						<div class="card  custom-card" style="height: 220px ;width: 328px;">
							<div class="header d-flex flex-row justify-content-between ">
								<img src="<?php echo base_url('assets/images/img/mastercard.png'); ?>" style="height: 80px; width: 80px;" class="card-img-top ml-2 p-3 mt-1" alt="">
								<img src="<?php echo base_url('assets/images/img/freeBadge.png'); ?>" style="height: 57px; width: 83px;" class="card-img-top p-3 mt-1" alt="">
							</div>
							<div class="" style="margin-left: 29px;">
								<p class=" custom-headig " style="margin-bottom: 2px">MasterCard</p>
								<p class=" custom-p">Connect to MasterCard Account</p>
							</div>
							<hr>
							<a class="custom-button" href="">
								<button style="text-align: center; border: none; background: none; margin-bottom: 15px;">Connect</button>
				...
				<section id="automationSection" style="display:none; margin-top:82px">
					...
					<main id="mainContent" class="container py-4 " style="margin-right: 550px; margin-top: -27px; border-radius:3px ">

						<head id="collectSection" style="display:none; " class="row custom-row">
							<header class="containers py-3 d-flex justify-content-between align-items-center ">
								<h2 style="  font-size: 23px;  font-weight: 600;">Automation </h2>
								<div class="d-flex ">


									<button type="button" class="btn btn-primarye float-end">+ Add new Rule</button>
								</div>
							</header>
							<header>
								<nav>
									<ul class="second-header">
										<li onclick="activateHeader(this)">General rules</li>
										<li style="    margin-left: 12px;" onclick="activateHeader(this)">Facebook rules
										</li>
										<li style="    margin-left: 12px;" onclick="activateHeader(this)">Instagram rules
										</li>
									</ul>
								</nav>
							</header>

							<main class="container  " style="    border: 1px solid #ccc;border-radius: 3px; padding: 0;">
								...
								<div class="table-responsive">
									<table class="table ">
										<thead>
											<tr style="">
												<th scope="col">
													<input type="checkbox" class="form-check-input me-1" style="margin-left: -4px;">
												</th>
												<th scope="col">Automation Rule </th>
										...
										<tbody style="">
											<tr>
												...
												<td><span class="minibadged ">in Draft</span></td>
												<td>30</td>
												<td>30</td>
												<td>30</td>
												<td>30</td>
				...
				<section id="customizeSection" style="display:none;">
					...
					<main style="margin-top: 101px;">
						<h2>
							this screen is not avaliable
						</h2>
					</main>
				</section>
				<!-- ///////////////////////fifth section end//////////////////////// -->
...
<script>
	...
	$("document").ready(function() {
			...
			$.ajax({
				...
				success: function(response) {
					...
					if (response.status == 1) {
						swal('<?php echo $this->lang->line('Success'); ?>', response.message, 'success').then((
							value) => {
							$("#media_count_" + table_id).text(response
								.media_count);
							$("#follower_count_" + table_id).text(response
								.follower_count);
						});
					} else {
					...
					if (willDelete) {
						...
						$.ajax({
							...
							success: function(response) {
								...
								if (response.status == 1) {
									swal('<?php echo $this->lang->line('Success'); ?>', response.message,
										'success').then((value) => {
										location.reload();
									});
								} else {
						...
						$.ajax({
							...
							success: function(response) {
								...
								if (response.status == 1) {
									...
									swal('<?php echo $this->lang->line('Error'); ?>', response.message,
										'error');
								}
							}
						});
		...
		$("#submit").click(function() {
			...
			var loading = '<br/><br/><img src="' + base_url +
				'assets/pre-loader/Fading squares2.gif" class="center-block"><br/>';
	...
	function activateHeader(element) {
		// Remove 'active' class from all list items
		var items = document.querySelectorAll('.second-header li');
