	...
	<header class="container ">
		<nav class=navbar>
			<ul class="nav nav-pills navpill justify-content-start">
				<li class="nav-item active"><a class="nav-link" href="#" onclick="loadContent('collect')">Collect</a></li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('connect')">Connect</a></li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('convert')">Convert</a></li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('automation')">Automation</a></li>
				<li class="nav-item"><a class="nav-link" href="#" onclick="loadContent('customize')">Customize</a></li>
			</ul>
		</nav>
...
<section class="section">
	...
	<div class="section-body">
		...
		<?php else : ?>
			<!-- FROM HEAR -->
			<main id="mainContent" class="container py-4" style="margin-left: 6px">
					...
					<div class="row custom-row">
						...
						<div class="card custom-card-1  flex-row  " style="margin-left: 12px; width: 328px;">
							<div class=" d-flex  ">
								...
								<div class="">
									<p class=" custom-headig" style="padding-top: 25px ;margin-bottom: 2px">Google Form</p>
						...
						<div class="card custom-card-1  flex-row  " style="margin-left: 12px; width: 328px;">
							<div class=" d-flex  ">
								...
								<div class="">
									<p class=" custom-headig " style="padding-top: 25px ;margin-bottom: 2px">BirdPos Mini</p>
									<p class=" custom-p">Serenity sisters</p>
								</div>
							</div>

						</div>
						<!-- <div class="card custom-card-1 col-md-4 flex-row  "style="margin-left: 12px;" >
							<div class=" d-flex  ">
							<img src="<?php echo base_url('assets/images/img/whatsapp.png'); ?>" style="height: 100px; width: 100px;" class="card-img-top p-3 " alt="">
							<div class="">
								<p class=" custom-headig " style="padding-top: 25px ;margin-bottom: 2px">Whatsapp</p>
								<p class=" custom-p">Friday Chuas</p>
							</div>
							</div>
				...
				<section id="connectSection" style="display:none;" class=" row custom-row">
					...
					<div class="d-flex flex-row ">
						<div class="card  custom-card" style="height: 220px ;width: 328px;">
							...
							<button type="button" class="btn btn-lg btn-primary">Connect</button>
