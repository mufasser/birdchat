<script>
  ...
  $(document).on('change','input[name=pageresponse_message_type]',function(){    
    if($("input[name=pageresponse_message_type]:checked").val()=="generic")
    {
      ...
      $("#pageresponse_ai_message_div").hide();
    ...
    else if($("input[name=pageresponse_message_type]:checked").val()=="ai_reply")
    {
      $("#pageresponse_generic_message_div").hide();
      $("#pageresponse_filter_message_div").hide();
      $("#pageresponse_ai_message_div").show();
    }
    else 
    {
      $("#pageresponse_generic_message_div").hide();
  ...
  $(document).on('click','#pageresponse_save_button',function(){
    ...
    if(reply_type == 'ai_reply') $("#pageresponse_ai_reply_enabled").val('1');
    else $("#pageresponse_ai_reply_enabled").val('0');
  ...
  $(document).on('click','.pageresponse_edit_reply_info',function(e){
    ...
    $.ajax({
      ...
      success:function(response){
        ...
        $("#pageresponse_edit_ai_message_private").html(response.postbacks);
        ...
        if(response.ai_reply_enabled == '1')
        {
          ...
          $("#pageresponse_edit_ai_training_data").val(response.ai_training_data).click();
          $("#pageresponse_edit_ai_message_div").show();
          $("#pageresponse_edit_ai_message_private").val(response.auto_reply_text).click();
        }
        else
        {
          if(response.reply_type == 'generic')
          {
            ...
            $("#pageresponse_edit_filter_message_div").hide();
            $("#pageresponse_edit_ai_message_div").hide();
            var i=1;
  ...
  $(document).on('click','#pageresponse_edit_save_button',function(){
    ...
    if(reply_type == 'ai_reply') $("#pageresponse_edit_ai_reply_enabled").val('1');
    else $("#pageresponse_edit_ai_reply_enabled").val('0');
  ...
  $(document).on('change','input[name=pageresponse_edit_message_type]',function(){    
    ...
    else if($("input[name=pageresponse_edit_message_type]:checked").val()=="ai_reply")
    {
      $("#pageresponse_edit_generic_message_div").hide();
      $("#pageresponse_edit_filter_message_div").hide();
    }
