                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="send-box">
                                            <form action="<?php echo base_url('home/send_messages'); ?>" method="post">
                                                <input type="text" id="message" name="message" class="form-control" aria-label="message…" placeholder="Write message…" required>
                                                <!-- <input type="submit" value="Send">Send<i class="fa fa-paper-plane" aria-hidden="true"></i> -->
