                            ...
                            foreach($modules as $module=>$values){
                                ...
                                <tr class="border-0">
                                    ...
                                    <td class='text-left px-3'>
                                        <div class="form-check form-switch d-flex p-0">
                                            <input  name="modules[]" id="box<?php echo $SL; ?>" class="modules regular-checkbox"  type="checkbox" value="<?php echo $values['id'] ?>"/>
                                    ...
                                    <td class='px-3'>
                                      ...
                                      <?php foreach($access_array as $access_key=>$access_value){?>
                                          <?php
                                              $access_sl++;
                                          ?>
                                          <input name="team_access[<?= $values['id'] ?>][]" id="team_access<?= $access_sl ?>" class="<?php echo $hide_action;?> team_access module_access<?= $values['id'] ?> regular-checkbox" type="checkbox" value="<?= $access_key ?>">
