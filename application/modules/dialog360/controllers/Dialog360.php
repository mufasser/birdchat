<?php
/*
Addon Name: Dialog360
Unique Name: dialog360
Modules:
{
   "285":{
      ...
      "limit_enabled":"0",
      "extra_text":"month",
      "module_name":"Dialog360"
   },
}
Project ID: 360
Addon URI: https://cims.world
Author: Vic
Author URI: http://cims.world
Version: 1.0
...
class Dialog360 extends Home
{
	
	private $apiUrl = "https://waba-sandbox.360dialog.io/v1";
	// private $apiKey = '7Vc1FB_sandbox'; // mi key
	private $apiKey = '2tK93C_sandbox'; // mi key
	...
	function sendSimpleMessage()
	{
		...
		CURLOPT_URL => 'https://waba-sandbox.360dialog.io/v1/messages',
    ...
    public function api() 
    {
        $data['page_title'] = $this->lang->line('360 Dialog');
		$data['title'] = $this->lang->line('360 Dialog');
        $data['product_name'] = $this->config->item('product_name');
        $data['endpoint'] = base_url('/dialog360');

        $this->load->view('dialog360/api', $data);
    }
	...
	public function webhook()
	{
		...
		if ($new_contact_id = $this->insert('dialog360_webhook_data', $data)) {
			$data = [
				'status' => 'success',
