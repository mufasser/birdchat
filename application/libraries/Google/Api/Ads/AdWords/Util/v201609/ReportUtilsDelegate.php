 ...
 *             Version 2.0
 */
require_once  FCPATH."application/libraries/Google/Api/Ads/AdWords/Lib/AdWordsUser.php";
require_once  FCPATH."application/libraries/Google/Api/Ads/AdWords/Util/ReportDownloadException.php";
require_once  FCPATH."application/libraries/Google/Api/Ads/Common/Util/CurlUtils.php";
require_once  FCPATH."application/libraries/Google/Api/Ads/Common/Util/Logger.php";
require_once  FCPATH."application/libraries/Google/Api/Ads/Common/Util/XmlUtils.php";
require_once  FCPATH."application/libraries/Google/Api/Ads/AdWords/Util/v201609/ReportClasses.php";
require_once  FCPATH."application/libraries/Google/Api/Ads/AdWords/Util/XmlDeserializer.php";
require_once  FCPATH."application/libraries/Google/Api/Ads/AdWords/Util/XmlSerializer.php";
