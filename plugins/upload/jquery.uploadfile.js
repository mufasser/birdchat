...
! function(e) {
    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        function v(t, o, s, l, n, d) {
            var h = {
                ...
                error: function(e, a, r) {
                    ...
                    /* Commented by Konok 07.05.2020 to show the actual error message text from ajax request instead of showing parse errror. 
                    ...
                    s.cancel.remove(), D.pop(), s.abort.hide(), "abort" == e.statusText ? (s.statusbar.hide("slow").remove(), c(o, n)) : (o.onError.call(this, l, a, r, s), o.showStatusAfterError ? (s.progressDiv.hide(), s.statusbar.append("<span class='" + o.errorClass + "'>ERROR: " + r + "</span>")) : (s.statusbar.hide(), s.statusbar.remove()), n.selectedFiles -= l.length), t.remove() */
                     ...
                     s.cancel.remove(), D.pop(), s.abort.hide(), "abort" == e.statusText ? (s.statusbar.hide("slow").remove(), c(o, n)) : (o.onError.call(this, l, a, r, s), o.showStatusAfterError ? (s.progressDiv.hide(), s.statusbar.append("<span class='" + o.errorClass + "'>ERROR: " + e.responseText + "</span>")) : (s.statusbar.hide(), s.statusbar.remove()), n.selectedFiles -= l.length), t.remove()
        ...
        var w = e.extend({
            ...
            dragDropStr: "<span><b><i class='fa fa-arrows-alt'></i> "+upload_lang_drag_drop_files+"</b></span>",
            uploadStr: "<i class='fa fa-cloud-upload-alt'></i> "+upload_lang_upload,
            abortStr: "<i class='fa fa-ban'></i> "+upload_lang_abort,
            cancelStr: "<i class='fa fa-remove'></i> "+upload_lang_cancel,
            deletelStr: "<i class='fa fa-trash'></i> "+upload_lang_delete,
            doneStr: "<i class='fa fa-check-circle'></i> "+upload_lang_done,
            multiDragErrorStr: upload_lang_multiple_file_drag_drop_is_not_allowed,
            extErrorStr: upload_lang_is_not_allowed_allowed_extensions,
            duplicateErrorStr: upload_lang_is_not_allowed_file_already_exists,
            sizeErrorStr: upload_lang_is_not_allowed_allowed_max_size,
            uploadErrorStr: upload_lang_upload_is_not_allowed,
            maxFileCountErrorStr: " "+upload_lang_is_not_allowed_maximum_allowed_files_are,
            downloadStr: "<i class='fa fa-download'></i> "+upload_lang_download,
